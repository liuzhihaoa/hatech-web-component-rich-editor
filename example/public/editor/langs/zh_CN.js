...
//以下为补充汉化内容 by 莫若卿
  ...
  "More...": "更多...",
  "Additional step needed to paste images": "粘贴图像所需的附加步骤",
  "Your browser requires you to take one more action to paste the images in your content. Please press the below keys to complete the image paste:": "您的浏览器要求您再执行一个操作以将图像粘贴到内容中。请按以下键完成图像粘贴：",
  "Press ": "按",
  "\"Close\"": "\"关闭\"",
  "to paste your content without images.": "以粘贴不带图像的内容。"
});
